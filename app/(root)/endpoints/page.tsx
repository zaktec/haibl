    ...
    },
    {
      ...
      endpoints: [
        ...
        },
        {
          ...
          params: 'id: User ID',
          example: 'PUT /admin/users/1',
          body: { firstName: 'John', lastName: 'Smith', email: 'johnsmith@example.com' }
        },
        {
          id: 'delete-user',
          method: 'DELETE',
    ...
    },
    {
      ...
      endpoints: [
        ...
        },
        {
          ...
          example: 'PUT /admin/content/1',
          body: { name: 'Advanced Algebra', published: false }
        },
        {
          id: 'delete-content',
          method: 'DELETE',
    ...
    },
    {
      ...
      endpoints: [
        ...
        },
        {
          ...
          params: null,
          example: 'POST /admin/bookings',
          body: { tutorId: 2, studentId: 3, scheduledStart: '2024-01-15T10:00:00Z', scheduledEnd: '2024-01-15T11:00:00Z', status: 'pending' }
        },
        {
          id: 'update-booking',
          method: 'PUT',
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Maths Learning Platform Endpoints</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <a href="/admin" className="text-gray-600 hover:text-gray-900 text-sm">Admin</a>
              <a href="/seed" className="bg-blue-500 text-white px-3 py-1 rounded text-sm hover:bg-blue-600">Seed DB</a>
